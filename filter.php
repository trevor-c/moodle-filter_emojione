...
/**
 * Filter converting shortcodes into emojione images
 *
 * This filter replaces shortcodes with emojione images.
 *
 * @package    filter
 * @subpackage emojione
...
require_once(__DIR__.'/../../lib/emojione/lib/php/autoload.php');

class filter_emojione extends moodle_text_filter {
    ...
    public function filter($text, array $options = array()) {
        ...
        if (in_array($options['originalformat'], explode(',', $this->get_global_config('formats')))) {
            $this->replace_emoji_shortcodes($text);
        }
        return $text;
    }
     ...
     * @return void
     */
    protected function replace_emoji_shortcodes(&$text) {
        ...
        Emojione\Emojione::$unicodeAlt = false;
        Emojione\Emojione::$ascii = true;
        Emojione\Emojione::$imagePathPNG = './../lib/emojione/assets/png/'; // defaults to jsdelivr's free CDN
        Emojione\Emojione::$imagePathSVG = './../lib/emojione/assets/svg/'; // defaults to jsdelivr's free CDN
        ...
        */
        ...
        $text = Emojione\Emojione::shortnameToImage($text);
